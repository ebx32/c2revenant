# C2 Framework Guide :D

![](assets/Screenshot_20260520_133727.png)
...
After installing dependencies, if you prefer to, you can build the beacon using build scripts.

> **NOTE**: This only works on linux

To compile the beacon with the updated `wlo1` IP address, run
...
Your beacon will compile to ./assets
...
To copy it into your virtual machine, you can execute the `host_file.sh` helper script
...
To restart the database (see "Restarting an engagement" for a manual method)
...
You can see the available commands by running `help`

![](assets/Screenshot_20260520_133842.png)
